...
private ["_hasCharge", "_hasSatchel", "_hasCharge2", "_hasSatchel2", "_mineType", "_pos", "_mine","_rustyTrigger"];
...
_hasCharge3 = "DemoCharge_Remote_Mag" in magazines player;
_hasSatchel3 = "SatchelCharge_Remote_Mag" in magazines player;

if !(player getVariable ["performingDuty", false]) then
{
	if (_hasCharge || _hasSatchel || _hasCharge2 || _hasSatchel2 || _hasCharge3 || _hasSatchel3) then
	{
