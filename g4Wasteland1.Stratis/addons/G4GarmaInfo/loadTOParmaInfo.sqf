...
_serverInfoString = format ["<t color='#A0FFFFFF'>G4G #%1 Wasteland %2</t>", call A3W_extDB_ServerID, worldName];
...
_generalInfoString = "Website: <t color='#0091CD'><a href='http://G4-Gamers.com'>G4-Gamers.com</a></t> Forums: <t color='#0091CD'><a href='http://G4-Gamers.com/forums'>G4-Gamers.com/forums</a></t> TeamSpeak: ts.g4-gamers.com";
_generalInfoText ctrlSetStructuredText parseText _generalInfoString;


//_rulesOnline = "http://www.g4-gamers.com/rules.php";
_rulesOffline = "addons\G4GarmaInfo\rules.html";
//_newsOnline = "http://www.g4-gamers.com/news.php";
_newsOffline = "addons\G4GarmaInfo\news.html";
//_statsOnline = "http://www.g4-gamers.com/stats.php?uid=" + _uid;
_statsOffline = "addons\G4GarmaInfo\stats.html";
