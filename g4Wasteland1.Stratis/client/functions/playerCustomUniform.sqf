	...
	case BLUFOR:
	{
		[] spawn
		{
			while {true} do
			{
					...
					{
						player setObjectTextureGlobal [0, format["client\images\vehicleTextures\%1_P.jpg", _uniformNumber]];
						player setObjectTextureGlobal [1, format["client\images\vehicleTextures\%1_P.jpg", _uniformNumber]];
						player setObjectTextureGlobal [2, format["client\images\vehicleTextures\%1_P.jpg", _uniformNumber]];
						backpackContainer player setObjectTextureGlobal [0, format["client\images\vehicleTextures\%1_P.jpg", _uniformNumber]];
						sleep 1;
						waitUntil {uniform player != "U_B_CombatUniform_mcam", "U_B_Protagonist_VR"};
					};  
			};
