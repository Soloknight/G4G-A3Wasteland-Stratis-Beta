...
private ["_dialog", "_input", "_amount", "_balance", "_maxBalance","_donatorLevel"];
...
_maxBalance = switch (_donatorLevel) do
	{
		...
		case 5: {_maxBalance + 2000000;};
		case 6: {_maxBalance + 2000000;};
		case 7: {_maxBalance + 2000000;};
		case 8: {_maxBalance + 2000000;};
		case 9: {_maxBalance + 2000000;};
		default {_maxBalance};
	};
