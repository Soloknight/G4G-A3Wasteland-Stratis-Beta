...
player createDiarySubject ["infos2", "More Info"];
...
<br/> End - For Earplugs 
<br/> Insert - Spawns an ATV at your location.
...
"g4-gamers v2.01",
"
<br/>[Added] Smugglers with out hot spots
<br/>[Added] Change Ownership Gas Station (South)
<br/>[Added] Bounty Hunter Mission System
<br/>[Added] Message System
<br/>[Added] Added A south Safe Zone
<br/>[Added] Added Safes!
<br/>[Added] Added a ATM at Kill Farm
<br/>[Added] Added Drug Missions
<br/>[Added] Added insert key for OTU ATV
<br/>[Changed] Sell Vehicles to vendors
<br/>[Changed] Updated antihack
<br/>[Changed] Territories and Payouts!
<br/>[Fixed] Discounted Bounties on reconnect
<br/>[Fixed] Thermal imaging not working for UAVs
<br/>[Fixed] Fixed Vendors
<br/>[Fixed] Various minor bugfixes and optimizations
<br/>[Deleted]Change ownership vehicles
<br/>[Deleted] Useless Territories
"
]];
player createDiaryRecord ["changelog",
[
